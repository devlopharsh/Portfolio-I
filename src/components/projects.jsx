      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full h-full absolute overflow-hidden backdrop-blur-md">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center h-full w-full scale-85 md:scale-100 relative top-7 md:top-0">
          ...
          <motion.section
            ...
            viewport={{ once: true, amount: 0.5 }}
          >
            <h1 className="text-5xl text-white font-bold backdrop-blur-md md:backdrop-blur-none ">
              Web Development
            </h1>
            <SlidingWindow>
              {/* TVIC */}
                ...
                <div className="flex-col items-center justify-center py-8 md:py-10 w-4/5 md:w-2/3">
                  <div className="border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center backdrop-blur-xl bg-white/">
                    <img
                      ...
                      width={220}
                    />
                    <h4>Next.js, TypeScript, Express.js, and MongoDB, etc.</h4>
                    <p className="text-[#8892b0] text-md mt-4 max-w-xl text-center">
                      Built a verification tool to check the authenticity of
                      integrated circuits.Designed an intuitive dashboard for
                      users to validate IC details and a secure backend logic
                      and dynamic frontend rendering to ensure accurate and
                      reliable verification.Deployed the project on Vercel for
              ...
              <div className="h-fit md:h-full rounded-xl flex  items-start justify-center text-white  ">
                <div className="flex-col items-center justify-center py-8 md:py-10 w-4/5 md:w-2/3">
                  <div className="border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center backdrop-blur-xl bg-white/">
                    ...
                    <h4>MERN stack</h4>
                    <p className="text-[#8892b0] text-md mt-4 max-w-xl text-center">
                      Designed responsive and interactive UI components for
                      intuitive data insights and credit tracking.Implemented
                      REST APIs for secure data exchange and efficient backend
                      communication.Responsible for both frontend and backend
                      development, ensuring reliability and scalability.
                    </p>
                    <button
                      onClick={() =>
              ...
              <div className="h-fit md:h-full rounded-xl flex  items-start justify-center text-white  ">
                <div className="flex-col items-center justify-center py-8 md:py-10 w-4/5 md:w-2/3">
                  <div className="border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center backdrop-blur-xl bg-white/">
                    ...
                    <p className="text-[#8892b0] text-md mt-4 max-w-xl text-center">
                      Interactive Website Used react js to build the UI , Use
                      the help of local browser storage in order to save
                      password and maintaining privacy of the user , Used a
                      clean and simple UI so that it can be understandable by
                      the user easily.{" "}
                    </p>
                    <button
                      onClick={() =>
                        window.open(
                          "https://reactdemo-project.vercel.app/",
                          "_blank"
                        )
                      }
                      className="mt-3 md:mt-6 border border-pink-500 text-pink-500 px-6 py-2 hover:bg-pink-500 hover:text-white transition rounded-3xl"
              ...
              <div className="h-full rounded-xl flex items-start justify-center text-white ">
                <div className="flex-col items-center justify-center py-8 md:py-10 w-4/5 md:w-2/3">
                  <div className="border-2 border-[#fb64b75e] my-2 rounded-3xl py-6 px-5 flex flex-col items-center justify-center backdrop-blur-xl bg-white/">
                    ...
                    <h4>React JS , Tailwind CSS , Vercel , etc.</h4>
                    <p className="text-[#8892b0] text-md mt-4 max-w-xl text-center">
                      Interactive Authantication Webpage Designed pixel perfect
                      and to the point for better UI Experience . Used a react
                      js to build the UI , Use the help of react library and
                      Tailwind CSS to make a clean and better UI .{" "}
                    </p>
                    <button
                      onClick={() =>
                        window.open(
                          "https://educase-project-one.vercel.app/",
                          "_blank"
                        )
                      }
                      className="mt-3 md:mt-6 border border-pink-500 text-pink-500 px-6 py-2 hover:bg-pink-500 hover:text-white transition rounded-3xl"
                ...
                <div className="flex-col items-center justify-center py-8 md:py-10 w-4/5 md:w-2/3">
                  <div className="border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center backdrop-blur-xl bg-white/">
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          "https://www.figma.com/design/63YoRUCXMHQYNaJDUutWTZ/Sukoon?node-id=1-2&t=mpyLfiMZuUMEimUh-1",
                          "_blank"
                        )
                      }
                      className="mt-3 md:mt-6 border border-pink-500 text-pink-500 px-6 py-2 hover:bg-pink-500 hover:text-white transition rounded-3xl"
