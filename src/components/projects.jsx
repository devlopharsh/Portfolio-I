...
const Projects = () => {
    return (
        <div className='flex flex-col md:flex-row items-center justify-between px-10 h-[70vh] relative overflow-hidden'>
            ...
            <motion.section
                className=" absolute w-full h-full md:w-1/2 md:h-[50vw] md:relative z-[0] top-0 left-0 flex-col items-center justify-center md:z-10 overflow-hidden"
            ...
            <motion.section
                className="w-[100vw] md:w-1/2  h-full relative flex-col items-center justify-center z-20"
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 1 }}
                viewport={{ once: true, amount: 0.5 }}
            >
                <h1 className='text-5xl text-white font-bold backdrop-blur-md md:backdrop-blur-none '>Projects</h1>
                <SlidingWindow>
