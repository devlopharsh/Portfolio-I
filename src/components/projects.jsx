    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-between px-10 h-[70vh] relative overflow-hidden'>
            ...
            >
                ...
                <SlidingWindow>
                    <div className="h-full rounded-xl flex items-center justify-center text-white text-xl">
                        <div className='flex-col items-center justify-center py-10 w-2/3'>
                            <div className='border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center '>
                                ...
                                <h3>React JS , Tailwind CSS , Vercel , etc.</h3>
                                <p className='text-[#8892b0] mt-4 max-w-xl text-center'>Interactive Website Designed to Save your Password locally and manage them easily. Used a react js to build the UI , Use the help of local browser storage in order to save password and maintaining privacy of the user , Used a clean and simple UI so that it can be understandable by the user easily.  </p>
                                <button
                    ...
                    <div className="h-full rounded-xl flex items-center justify-center text-white text-xl">
                        <div className='flex-col items-center justify-center py-10 w-2/3'>
                            <div className='border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center '>
                                <img src="./PopX.svg" alt="Passaver" height={300} width={300} />
                                <h3>React JS , Tailwind CSS , Vercel , etc.</h3>
                                <p className='text-[#8892b0] mt-4 max-w-xl text-center'>Interactive Authantication Webpage Designed pixel perfect and to the point for better UI Experience . Used a react js to build the UI , Use the help of react library and Tailwind CSS to make a clean and better UI .  </p>
                                <button
                    ...
                    <div className="h-full rounded-xl flex items-center justify-center text-white text-xl">
                        <div className='flex-col items-center justify-center py-10 w-2/3'>
                            <div className='border-2 border-[#fb64b75e] my-2 rounded-3xl py-8 px-5 flex flex-col items-center justify-center '>
                                <img src="./Sukoon.svg" alt="Passaver" height={500} width={500} />
                                <h3>Figma , Prototyping , UX , Product Designing ,etc.</h3>
                                <p className='text-[#8892b0] mt-4 max-w-xl text-center'>Interactive Authantication Webpage Designed pixel perfect and to the point for better UI Experience . Used a react js to build the UI , Use the help of react library and Tailwind CSS to make a clean and better UI .  </p>
                                <button
